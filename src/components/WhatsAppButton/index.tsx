  ...
  function handleSendPushNotification() {
    ...
    const options = {
      ...
      headers: {
        ...
        Authorization:
          "Key os_v2_app_l57jrwm4zjhincvkhxq6r6rw27wlnvi2vjwecmvlpzztiyesdvxook6y45sy6h4xmq6ndfznwmal3zdtmzrgysn6pjonyspgjwfspkq",
      ...
      body: JSON.stringify({
        ...
        include_external_user_ids: [
          "jacksonmichalak@gmail.com",
          "vitorbonet@gmail.com",
        ],
      }),
    };
